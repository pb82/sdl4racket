...
(define (sdl-active-constructor raw-pointer)
...
(define (sdl-mouse-motion-constructor raw-pointer)
...
(define (sdl-keyboard-constructor raw-pointer)
...
(define (sdl-mouse-button-constructor raw-pointer)
...
(define (sdl-joy-axis-constructor raw-pointer)
      ...
      (lambda (msg)
        (case msg         
          ...
          ((EVENT) (case (sdl-event-type event)
                      ((SDL_ACTIVEEVENT)      (sdl-active-constructor       event))
                      ...
                      ((SDL_MOUSEBUTTONDOWN)  (sdl-mouse-button-constructor event))
                      ((SDL_MOUSEBUTTONUP)    (sdl-mouse-button-constructor event))
                      ((SDL_JOYAXISMOTION)    (sdl-joy-axis-constructor     event))
